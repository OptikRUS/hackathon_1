...
class CianParser:
    ...
    def __init__(self, bbox, center, floor, min_year, max_year, house_material_type='1', room_type='1'):
        ...
        self.params[f"room"] = room_type
        self.params["house_material[0]"] = house_material_type
